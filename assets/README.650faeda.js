import{z as a,A as n}from"./index.5b501510.js";const s=a({name:"Markdown"}),l=()=>n("div",{class:["md2vue-wrapper","markdown-body"],innerHTML:`<h2 id="\u79FB\u52A8\u7AEFui\u6846\u67B6">\u79FB\u52A8\u7AEFUI\u6846\u67B6</h2>
<p>\u57FA\u4E8EVue3\u7684\u79FB\u52A8\u7AEFUI\u6846\u67B6</p>
<h3 id="\u6587\u6863">\u6587\u6863</h3>
...
<pre><code class="language-css"><div class="md-code-hijs"><span class="hljs-selector-pseudo">:root</span> {
  ...
  --loading-text: <span class="hljs-number">#999</span>;
