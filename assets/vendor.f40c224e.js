...
function toRefs(object3) {
  const ret = isArray$2(object3) ? new Array(object3.length) : {};
...
function computed(getterOrOptions, debugOptions) {
  ...
  const cRef = new ComputedRefImpl(getter, setter, isFunction$3(getterOrOptions) || !getterOrOptions.set);
  return cRef;
}
Promise.resolve();
...
function emit(instance, event, ...rawArgs) {
  ...
  if (modelArg && modelArg in props) {
    ...
    const { number: number3, trim } = props[modifiersKey] || EMPTY_OBJ$1;
    if (trim) {
...
const normalizeRef = ({ ref: ref2 }) => {
  return ref2 != null ? isString$1(ref2) || isRef(ref2) || isFunction$2(ref2) ? { i: currentRenderingInstance, r: ref2 } : ref2 : null;
};
...
const PublicInstanceProxyHandlers = {
  ...
  has({ _: { data, setupState, accessCache, ctx, appContext, propsOptions } }, key) {
    let normalizedProps;
    return accessCache[key] !== void 0 || data !== EMPTY_OBJ$1 && hasOwn(data, key) || setupState !== EMPTY_OBJ$1 && hasOwn(setupState, key) || (normalizedProps = propsOptions[0]) && hasOwn(normalizedProps, key) || hasOwn(ctx, key) || hasOwn(publicPropertiesMap, key) || hasOwn(appContext.config.globalProperties, key);
  }
};
...
const vModelText = {
  ...
  beforeUpdate(el, { value, modifiers: { lazy, trim, number: number3 } }, vnode) {
    ...
    if (document.activeElement === el) {
      ...
      if ((number3 || el.type === "number") && toNumber(el.value) === value) {
        return;
      }
    }
    const newValue = value == null ? "" : value;
...
const vModelSelect = {
  ...
  created(el, { value, modifiers: { number: number3 } }, vnode) {
    ...
    addEventListener(el, "change", () => {
      const selectedVal = Array.prototype.filter.call(el.options, (o) => o.selected).map((o) => number3 ? toNumber(getValue(o)) : getValue(o));
  ...
  for (const segment of segments) {
    ...
    for (let tokenIndex = 0; tokenIndex < segment.length; tokenIndex++) {
      ...
      if (token.type === 0) {
        ...
        const { value, repeatable, optional, regexp: regexp3 } = token;
        keys.push({
          name: value,
          repeatable,
          optional
        });
        const re2 = regexp3 ? regexp3 : BASE_PARAM_PATTERN;
...
export { onUnmounted as A, normalizeClass as B, createTextVNode as C, renderList as D, vModelCheckbox as E, Fragment as F, reactive as G, withModifiers as H, createVNode as I, provide as J, onBeforeUnmount as K, vModelDynamic as L, toHandlers as M, vModelText as N, withCtx as O, createApp as P, pushScopeId as Q, popScopeId as R, Schema as S, Teleport as T, defineComponent as U, Vue as V, useRoute as W, useRouter as X, createRouter as a, createWebHashHistory as b, createBlock as c, createElementBlock as d, createBaseVNode as e, renderSlot as f, getCurrentInstance as g, createStaticVNode as h, h as i, render as j, resolveDynamicComponent as k, createCommentVNode as l, mergeProps as m, markRaw as n, openBlock as o, nextTick as p, ref as q, resolveComponent as r, computed as s, toDisplayString as t, onMounted as u, vShow as v, withDirectives as w, normalizeStyle as x, inject as y, watch as z };
