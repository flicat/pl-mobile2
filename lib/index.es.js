    ...
    createElementVNode("div", {
      ...
      createElementVNode("div", _hoisted_2$8, [
        createElementVNode("div", {
          ...
          ])) : !$props.multiple && $setup.calcOptions.get($setup.currentValue) ? (openBlock(), createElementBlock("span", _hoisted_4$6, toDisplayString($setup.calcOptions.get($setup.currentValue)), 1)) : (openBlock(), createElementBlock("span", _hoisted_5$2, toDisplayString($props.placeholder), 1))
        ]),
        withDirectives(createElementVNode("div", {
