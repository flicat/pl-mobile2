  ...
  setup(props, context) {
    ...
    const clear = () => {
      if (props.multiple) {
        ...
        currentValue.value = props.options.length && typeof props.options[0][props.prop.value] === "string" ? "" : null;
      }
      context.emit("clear");
    };
    const submit = () => {
    ...
    createElementVNode("div", {
      ...
      createElementVNode("div", _hoisted_2$8, [
        createElementVNode("div", {
          ...
          ])) : !$props.multiple && $setup.calcOptions.has($setup.currentValue) ? (openBlock(), createElementBlock("span", _hoisted_4$6, toDisplayString($setup.calcOptions.get($setup.currentValue)), 1)) : (openBlock(), createElementBlock("span", _hoisted_5$2, toDisplayString($props.placeholder), 1))
        ]),
        withDirectives(createElementVNode("div", {
...
const _sfc_main$3 = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props, { emit }) {
    const props = __props;
    useCssVars((_ctx) => ({
      "5855c80c": unref(transformSize),
      "77376f85": props.duration,
      "beacd258": unref(scrollItemSize)
    }));
